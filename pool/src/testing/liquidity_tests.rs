...
fn test_fee_distribution_proportional() {
    ...
    let info1 = mock_info("lp1", &[Coin { denom: "bluechip".to_string(), amount: Uint128::new(1000) }]);
    ...
    let info2 = mock_info("lp2", &[Coin { denom: "bluechip".to_string(), amount: Uint128::new(2000) }]);
