...
echo "  Commit:                     {\"commit\":{\"asset\":{\"info\":{\"bluechip\":{\"denom\":\"stake\"}},\"amount\":\"AMT\"},\"amount\":\"AMT\",\"transaction_deadline\":null,\"belief_price\":null,\"max_spread\":null}}"
echo "  SimpleSwap:                 {\"simple_swap\":{\"offer_asset\":{\"info\":{\"bluechip\":{\"denom\":\"stake\"}},\"amount\":\"AMT\"},\"belief_price\":null,\"max_spread\":null,\"to\":null,\"transaction_deadline\":null}}"
echo "  DepositLiquidity:           {\"deposit_liquidity\":{\"amount0\":\"AMT0\",\"amount1\":\"AMT1\",\"min_amount0\":null,\"min_amount1\":null,\"transaction_deadline\":null}}"
echo "  AddToPosition:              {\"add_to_position\":{\"position_id\":\"ID\",\"amount0\":\"AMT0\",\"amount1\":\"AMT1\",\"min_amount0\":null,\"min_amount1\":null,\"transaction_deadline\":null}}"
echo "  RemovePartialLiquidity:     {\"remove_partial_liquidity\":{\"position_id\":\"ID\",\"liquidity_to_remove\":\"AMT\",\"transaction_deadline\":null,\"min_amount0\":null,\"min_amount1\":null,\"max_ratio_deviation_bps\":null}}"
echo "  RemovePartialLiquidityPct:  {\"remove_partial_liquidity_by_percent\":{\"position_id\":\"ID\",\"percentage\":50,\"transaction_deadline\":null,\"min_amount0\":null,\"min_amount1\":null,\"max_ratio_deviation_bps\":null}}"
echo "  RemoveAllLiquidity:         {\"remove_all_liquidity\":{\"position_id\":\"ID\",\"transaction_deadline\":null,\"min_amount0\":null,\"min_amount1\":null,\"max_ratio_deviation_bps\":null}}"
echo "  CollectFees:                {\"collect_fees\":{\"position_id\":\"ID\"}}"
echo "  ClaimCreatorExcessLiquidity:{\"claim_creator_excess_liquidity\":{}}"
echo "  Pause:                      {\"pause\":{}}"
echo "  Unpause:                    {\"unpause\":{}}"
echo "  EmergencyWithdraw:          {\"emergency_withdraw\":{}}"
echo "  CancelEmergencyWithdraw:    {\"cancel_emergency_withdraw\":{}}"
