#!/bin/bash
# =====================================================================
# Threshold-Crossing 3% Guard Test
#
...
# leftover ("excess") would consume more than 3% of the freshly seeded
...
#   3. Bob commits 80M ubluechip — overshoots by ~75M (≫ 3% of seed)
...
# =====================================================================
hdr "5. OVERSHOOT — TRIGGER 3% GUARD"
# =====================================================================
# Need only ~5M ubluechip (~\$50) more to cross. Commit 80M instead so the
# excess swap (~75M) is far above 3% of the freshly seeded reserve0.
OVER=80000000
...
info "bluechip_excess_refunded    = $REFUNDED  ← 3% guard refund"
...
# Sanity: capped_excess should be ≤ 3% of reserve0_after
...
echo "    refunded (3%)     = $REFUNDED ubluechip"
echo ""
if [ $F -eq 0 ]; then
